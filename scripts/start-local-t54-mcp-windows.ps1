# Open two PowerShell windows: T54 seller 24h daemon + MCP SSE (127.0.0.1:9051).
...
$t2 = "Set-Location -LiteralPath '$root'; try { `$Host.UI.RawUI.WindowTitle = 'Swarm: MCP SSE (9051)' } catch {}; npm run mcp:t54:sse"
