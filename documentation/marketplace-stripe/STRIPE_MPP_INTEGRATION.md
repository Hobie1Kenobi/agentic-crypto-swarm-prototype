...
Order creation today returns **200** with PaymentIntent / deposit instructions; stricter **HTTP 402** challenge/response behavior can be added later to match Node `mppx` middleware byte-for-byte.
